...
class InfoPage extends React.Component {
            ...
            info:[
                {
                    title:'ALOJAMIENTO',
                    url: '',
                    text:'Los voluntarios convivirán junto con los coordinadores en una casa del pueblo de Taznaqt, cerca de la ciudad de Errachidia.\n Los voluntarios compartirán habitaciones para dormir.•En las habitaciones hay colchones y almohadas. Recomendamos que los voluntarios traigan sus sábanas para mayor comodidad (tamaño cama individual), aunque también tenemos sábanas por si alguien necesitara o mantas.•La casa tiene cocina y dos baños, se tendrán que hacer turnos para ducharse.\n' +
                        'También hay una terraza con una jaimadonde los voluntarios suelen pasar el tiempo para desayunar, comer, preparar o hacer actividades o para organizar reuniones.•Los voluntarios pueden ir por el centro de la ciudad siempre que quieran durante su tiempo libre, pero tienen que ir siempre acompañados de un coordinador de la asociación por su comodidad y tranquilidad.•Hay una piscina de agua natural cerca del pueblo donde también pueden ir los voluntarios cuando quieran y donde hay programadas actividades grupales.',
                    image:require('assets/img/home.jpeg')
                },
                {
                    title:'LUGAR',
                    url: '',
                    text:'Los proyectos de enseñanza de idiomas y actividades lúdicas se realizan en la escuela primaria y las escuelas infantiles de Taznaqt.•Durante los proyectos de Navidad y Semana Santa no se realiza el proyecto deenseñanza de idiomas porque las vacaciones escolares en Marruecos no coinciden con las vacaciones en España. Por tanto, los niños tendrán que ir a clase cuando los voluntarios estén allí y no tenemos tanta disponibilidad para hacer uso de las escuelas.•Sin embargo, sí se contempla que los voluntarios acudan a las dos escuelas infantiles por la mañana para realizar actividades con los niños en clase.•El resto de actividades (por la tarde) se podrán realizar en las escuelas o en las plazas del pueblo.\n' +
                        'Las visitas al hospital se realizan en la ciudad de Errachidia. El hospital tiene un ala de pediatría donde podemos visitar a los niños internados con sus familias, y un edificio anexo que sirve como orfanato. También podremos ir a ver a los niños huérfanos y entregarles regalos. •El torneo de fútbol se organizará en un espacio libre del pueblo, cerca de la casa de la asociación. Es un espacio libre donde se improvisa un campo de fútbol trazando líneas en la tierra ya que no se dispone de ningún campo de fútbol en el pueblo, pero es una actividad que los niños agradecen ya que les gusta mucho',
    ...
    componentDidMount() {
        ...
        //     "  \"kind\": \"widget\",\n" +
        //     "  \"url\": \"https://www.videoask.it/f76ph5xha\",\n" +
        //     "  \"options\": {\n" +
        ...
        // document.getElementById('card1').appendChild(script);
        // var scripts = document.getElementsByTagName("script");
        // for (var i = 0; i < scripts.length; ++i) {
        //   var scriptE = scripts[i];
        //   eval(scriptE.innerHTML);
        // }

        //fupjis2s8
        //f76ph5xha
        //window.VIDEOASK_EMBED_CONFIG.url = 'https://www.videoask.it/f76ph5xha'
